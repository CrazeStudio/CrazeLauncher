...
JNIEXPORT void JNICALL
Java_git_artdeell_dnbootstrap_glfw_GLFW_sendMousePosition0(JNIEnv *env, jclass clazz,
                                                         jdouble v1, jdouble v2) {
    Java_git_artdeell_dnbootstrap_glfw_GLFW_sendMousePosition0__DD(env, clazz, v1, v2);
}
