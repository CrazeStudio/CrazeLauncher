...
public class CustomControlsActivity extends BaseActivity implements EditorExitable, CropperUtils.CropperReceiver {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		net.kdt.pojavlaunch.utils.CrazeAnimationUtils.attachTouchFeedback(mPullDrawerButton);
		net.kdt.pojavlaunch.utils.CrazeAnimationUtils.attachTouchFeedbackRecursively(findViewById(android.R.id.content));
