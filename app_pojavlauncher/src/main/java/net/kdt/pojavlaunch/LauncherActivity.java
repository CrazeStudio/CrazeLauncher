...
public class LauncherActivity extends BaseActivity implements androidx.preference.PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
            ...
            if (backButton != null) {
                if (isMainMenu) {
                    ...
                    if (screenTitle != null) {
                        ...
                        } else if (f instanceof net.kdt.pojavlaunch.fragments.InstanceManagementFragment) {
    ...
    private void bindViews(){
        ...
        CrazeAnimationUtils.attachTouchFeedbackRecursively(findViewById(android.R.id.content));
    }

    private static void attachTouchAnimation(View v) {
        CrazeAnimationUtils.attachTouchFeedback(v);
    }
}
