...
public class ControlData {
    ...
    public static final int SPECIALBTN_RECORD = -11;
    public static final int SPECIALBTN_SCREENSHOT = -12;
    ...
    public static ControlData[] getSpecialButtons() {
        if (SPECIAL_BUTTONS == null) {
            SPECIAL_BUTTONS = new ControlData[]{
                    ...
                    new ControlData("Record", new int[]{SPECIALBTN_RECORD}, "${margin}", "${margin}"),
                    new ControlData("Screenshot", new int[]{SPECIALBTN_SCREENSHOT}, "${margin}", "${margin}")
            };
        }
