...
public class ControlDrawer extends ControlButton {
    ...
    private void switchButtonVisibility(){
        ...
        animate()
                ...
                .scaleY(1.1f)
                .setDuration(70)
                .withEndAction(() -> animate().scaleX(1.0f).scaleY(1.0f).setDuration(120).setInterpolator(new android.view.animation.OvershootInterpolator(1.4f)).start())
                .start();

        for(int i = 0; i < buttons.size(); ++i){
            ControlSubButton sub = buttons.get(i);
            View v = sub.getControlView();
            if(areButtonsVisible) {
                ...
                v.animate()
                        ...
                        .scaleY(0.5f)
                        .setDuration(100)
                        .setStartDelay((buttons.size() - 1 - i) * 20L)
                        .withEndAction(() -> finalView.setVisibility(GONE))
                        .start();
            }
        }
    }
